-- UPDATE report_bs = 'Capital social / Aportes, neto'
-- Created: 2026-01-24
...
UPDATE tb_account
SET report_bs = 'Capital social / Aportes, neto'
WHERE code LIKE '310%';
...
-- Restore if needed:
-- UPDATE tb_account t
-- JOIN backup_tb_account_report_bs_pre_capital_social b ON t.id = b.id
