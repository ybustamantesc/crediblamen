<?php
// Script de prueba para importar la balanza de septiembre 2025 desde el archivo en temp/
// Ejecutar: php test_import_septiembre.php

$csvPath = 'C:/xampp/htdocs/lasminitas/temp/ejemplo_balanza_Septiembre_2025.csv';
