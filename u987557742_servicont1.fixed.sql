...
INSERT INTO `tb_account` (`id`, `code`, `name`, `type`, `naturaleza`, `parent_id`, `created_at`) VALUES
...
INSERT INTO `tb_journal` (`id`, `date`, `description`, `total_debit`, `total_credit`, `created_at`, `created_by`, `source_type`, `source_id`, `voided`, `voided_by`, `voided_at`, `period_month`, `period_year`, `entry_type`, `centro_costo_id`, `posted`, `posted_by`, `posted_at`) VALUES
...
INSERT INTO `tb_prestamo_cuotas` (`idcuota`, `idprestamo`, `numero`, `fecha_vencimiento`, `dias`, `principal`, `interes`, `cuota`, `saldo`, `created_at`, `comision`) VALUES
