...
aturaleza` enum('deudora','acreedora') DEFAULT NULL,
...
INSERT IGNORE INTO `tb_account` (`id`, `code`, 
ame`, `type`, 
aturaleza`, `parent_id`, `created_at`) VALUES
...
INSERT IGNORE INTO `tb_asesores` (`idasesor`, 
ombres`, `telefono`, `direccion`, `fechaRegistro`, `estado`) VALUES
...
umero_doc` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT IGNORE INTO `tb_centro_costo` (`id`, `codigo`, 
ombre`, `descripcion`, `activo`, `created_at`) VALUES
...
ombres` varchar(100) DEFAULT NULL,
  `direccion` varchar(100) DEFAULT NULL,
  `telefono` varchar(27) DEFAULT NULL,
  `email` varchar(100) DEFAULT NULL,
  `tipo_doc` int(11) NOT NULL,
  
umero_doc` varchar(50) NOT NULL,
...
ombre_empresa` varchar(255) DEFAULT NULL,
...
ombre_negocio` varchar(255) DEFAULT NULL,
...
INSERT IGNORE INTO `tb_clientes` (`idcliente`, `apellidos`, 
ombres`, `direccion`, `telefono`, `email`, `tipo_doc`, 
umero_doc`, `comentarios`, `estado`, `rechazado`, `fechaActualizacion`, `fecha_nacimiento`, `edad`, `estado_civil`, 
ombre_conyuge`, `dni_conyuge`, `ocupacion_conyuge`, `telefono_conyuge`, 
umero_dependientes`, `condicion_vivienda`, `tiempo_residir_anios`, `tiempo_residir_meses`, 
ombre_empresa`, `direccion_empresa`, `telefono_empresa`, `cargo_puesto`, `tiempo_empleo_anios`, `tiempo_empleo_meses`, `tipo_contrato`, `ingreso_mensual_neto`, `deducciones`, 
ombre_negocio`, `actividad_economica`, `telefono_negocio`, `tiempo_operacion_anios`, `tiempo_operacion_meses`, `ventas_buenos_amount`, `ventas_malos_amount`, `ventas_promedio_mensual`) VALUES
...
ombres` varchar(80) NOT NULL,
  `direccion` varchar(200) DEFAULT NULL,
  `telefono` varchar(30) DEFAULT NULL,
  `tipo_doc` tinyint(2) DEFAULT NULL,
  
umero_doc` varchar(60) DEFAULT NULL,
  `comentarios` text DEFAULT NULL,
...
umero_coutas` int(11) DEFAULT NULL,
...
umero_couta` int(11) DEFAULT NULL,
  `monto_capital` decimal(18,2) NOT NULL DEFAULT 0.00,
  `monto_interes` decimal(18,2) NOT NULL DEFAULT 0.00,
...
ombre` varchar(255) NOT NULL,
  `cantidad` int(11) DEFAULT 1,
  `marca` varchar(255) DEFAULT NULL,
  `modelo` varchar(255) DEFAULT NULL,
  
_serie` varchar(255) DEFAULT NULL,
...
INSERT IGNORE INTO `tb_garantias` (`id`, `solicitud_id`, 
ombre`, `cantidad`, `marca`, `modelo`, 
_serie`, `costo`, `tiempo_vida`, `foto__bak`, `foto1`, `foto2`, `foto3`, `foto4`, `foto5`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `tb_monedas` (`id`, 
ombre`, `simbolo`, `estado`) VALUES
(1, 'CORDOBAS', 'C$', 1),
(3, 'DOLARES', '$', 1);
...
ombre` varchar(255) DEFAULT NULL,
  `primer_apellido` varchar(255) DEFAULT NULL,
  `segundo_apellido` varchar(255) DEFAULT NULL,
  `tipo_documento` varchar(50) DEFAULT NULL,
  
umero_documento` varchar(100) DEFAULT NULL,
  `fecha_nacimiento` date DEFAULT NULL,
...
ivel_riesgo` varchar(50) DEFAULT NULL,
...
_dependientes` text DEFAULT NULL,
  
ombre_conocido` text DEFAULT NULL,
...
umero_registro` varchar(100) DEFAULT NULL,
...
INSERT IGNORE INTO `tb_perfil_integral_cliente` (`id`, `solicitud_id`, 
ombre`, `primer_apellido`, `segundo_apellido`, `tipo_documento`, 
umero_documento`, `fecha_nacimiento`, `telefono`, `celular`, `email`, `direccion`, `ciudad`, `estado_civil`, `ocupacion`, `empresa`, `ingreso_mensual`, `antiguedad_laboral`, `otros`, `created_at`, `updated_at`, `fecha_perfil`, 
ivel_riesgo`, `tipo_ddc`, `en_su_propio_pais`, `es_funcionario_publico`, `cargo_funcionario`, `pais_emision_documento`, `categoria_otro`, `zona_cobertura`, `sitio_web_centro_trabajo`, `ingreso_mensual_usd`, `ingreso_mensual_cordobas`, `conyuge_profesion`, `conyuge_ocupacion_actual`, `conyuge_nombre_centro_trabajo`, `conyuge_direccion_centro_trabajo`, `conyuge_email_centro_trabajo`, `conyuge_sitio_web`, `conyuge_telefono_centro_trabajo`, `conyuge_fax_centro_trabajo`, `conyuge_apartado_postal`, `conyuge_ingreso_usd`, `conyuge_ingreso_cordobas`, `documento_legal_1_pais_emision`, `documento_legal_2_pais_emision`, `actividad_esperada_json`, `segundo_nombre`, `sexo`, 
_dependientes`, 
ombre_conocido`, `pais_nacimiento`, `categoria_empleo`, `origen_fondos`, `proposito_relacion`, `actividad_esperada`, `conyuge_primer_nombre`, `conyuge_segundo_nombre`, `conyuge_primer_apellido`, `conyuge_segundo_apellido`, `conyuge_direccion`, `conyuge_telefono_domicilio`, `conyuge_celular`, `conyuge_email_personal`, `doc1_tipo`, `doc1_numero`, `doc1_registro`, `doc1_fecha_emision`, `doc1_vencimiento`, `doc2_tipo`, `doc2_numero`, `doc2_registro`, `doc2_fecha_emision`, `doc2_vencimiento`, `tipo_relacion`, `tipo_relacion_otro`, `origen_otros`, 
umero_registro`, `fecha_emision_documento`, `fecha_vencimiento_documento`, `documento_legal_1_numero`, `documento_legal_1_fecha_emision`, `documento_legal_1_fecha_vencimiento`, `documento_legal_2_numero`, `documento_legal_2_fecha_emision`, `documento_legal_2_fecha_vencimiento`, `matriz_score`, `matriz_answers`, `actividad_esperada_observaciones`) VALUES
...
INSERT IGNORE INTO `tb_prestamos` (`idprestamo`, `idsolicitud`, `monto_credito`, `monto_desembolsado`, `interes_credito`, `comision_desembolso`, 
umero_coutas`, `forma_pago`, `fecha_credito`, `estado`, `created_at`, `interes_corriente_anual`, `interes_moratorio`, `idasesor`, `promotor`, `tipo_cuota`, `fecha_desembolso`, `primer_dia_pago`, `saldo_inicial`, `pdf_printed_count`) VALUES
...
INSERT IGNORE INTO `tb_prestamo_cuotas` (`idcuota`, `idprestamo`, 
umero`, `fecha_vencimiento`, `dias`, `principal`, `interes`, `cuota`, `saldo`, `created_at`, `comision`) VALUES
...
ombre` varchar(100) DEFAULT NULL COMMENT 'Nombre legible de la serie, p.ej. "Serie A"',
...
INSERT IGNORE INTO `tb_series_recibos` (`idserie`, `codigo`, 
ombre`, `consecutivo`, `ultimo_emitido`, `created_on`, `updated_on`, `estado`) VALUES
...
egocio_propio` tinyint(1) DEFAULT 0 COMMENT '1=Si,0=No',
  
egocio_antiguedad` int(11) DEFAULT NULL COMMENT 'AntigÃ¼edad en meses',
...
umero_empleados` int(11) DEFAULT NULL,
...
ombre_completo` varchar(255) DEFAULT NULL,
...
ombre_promotor` varchar(255) DEFAULT NULL,
...
INSERT IGNORE INTO `tb_solicitud_referencias` (`idreferencia`, `idsolicitud`, `referencia_num`, 
ombre`, `cedula`, `direccion`, `telefono`, `tipo_referencia`, `desde_conoce_cliente`, `relacion_economica`, `opinion`, `comentarios`, `created_at`, `tipo_personal_relacion`) VALUES
...
INSERT IGNORE INTO `tb_tipo_productos` (`id`, 
ombre`, `porcentaje`, `estado`, `created_at`, `monto_min`, `monto_max`, `tasa_mensual`, `comision_desembolso`, `plazo_min`, `plazo_max`, `clasificacion`) VALUES
...
ame_muc` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
