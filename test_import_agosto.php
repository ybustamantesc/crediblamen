<?php
// Script de prueba para importar la balanza de agosto 2025 desde el archivo en temp/
// Ejecutar: php test_import_agosto.php

$csvPath = 'C:/xampp/htdocs/lasminitas/temp/ejemplo_balanza_Agosto_2025.csv';
