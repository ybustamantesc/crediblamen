<?php
// Script de prueba para importar la balanza de julio 2025 desde el archivo en temp/
// Ejecutar: php test_import_julio.php

// Ajustar ruta absoluta al archivo CSV
$csvPath = 'C:/xampp/htdocs/lasminitas/temp/ejemplo_balanza_julio_2025.csv';
