					...
					<div class="card comp-card">
						<div class="card-body">
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-25">IMPRESIÓN DE RECIBO</h6>
									<a target="_blank" class="btn bg-blue text-white" href="<?php echo base_url($this->router->fetch_class() . '/pdf/' . $pago->idpago); ?>">Imprimir</a>
				...
				<div class="col-xl-4 col-md-6">
					<div class="card comp-card">
						<div class="card-body">
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-25">LISTAR PAGOS</h6>
