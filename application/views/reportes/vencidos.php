	...
	<div class="main-content">
		<div class="container-fluid">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body text-center py-5">
							...
							<div class="small text-muted mt-2">Estamos preparando los datos de vencidos. Por favor espera.</div>
						</div>
					</div>
				</div>
			</div>
			...
			(function(){
				...
				if (!bar) return;
				let value = 0; const target = 75;
				const step = function(){ value += Math.random()*7; if (value>=target) value=target; bar.style.width = Math.round(value)+'%'; if (value<target) setTimeout(step, 350+Math.random()*300); else bar.classList.add('pulse'); };
				setTimeout(step, 300);
			})();
			</script>
