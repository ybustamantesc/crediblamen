    ...
    <table>
        ...
        <?php foreach ($prestamos as $prestamo) : ?>
            ...
            if ($estado_cuota == 1) {
                ...
                if ($fechaAtual < $fechaVencimiento) {
                    $estado = '<span class="badge  badge-info mb-1"><i class="fas fa-info-circle"></i> PENDIENTE</span>';
                }
            } else {
                $estado = '<span class="badge  badge-success mb-1"><i class="fas fa-check"></i> CANCELADO</span>';
            }

            ?>
            <tr>
                <td><?php echo $i; ?></td>
                <td><?php echo $prestamo->idcredito; ?></td>
