				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header d-block">
							<h3>Estado de Cuenta por Cliente</h3>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<select name="" id="cboClienteEstadoCuenta" class="form-control select2">
							...
							<table class="table data-table table-striped table-bordered table-hover" id="tablaEstadoCuentaCliente">
								<thead>
									<tr>
										<th class="nosort">#</th>
										<th>Crédito</th>
