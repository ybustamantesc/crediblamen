...
<div class="page-wrap">
	...
	<div class="main-content">
		<div class="container-fluid">
				...
				<div class="col-12">
					<div class="card chart-card">
						<div class="card-body text-center py-5">
							...
							<div class="small text-muted mt-2">Preparando indicadores y gráficos. Espere un momento.</div>
						</div>
					</div>
				</div>
			</div>
			...
			<script>
			(function(){
				const bar = document.querySelector('.upcoming-progress .progress-bar'); if (!bar) return; let v=0, target=82; const step=function(){ v+=Math.random()*5; if(v>=target)v=target; bar.style.width=Math.round(v)+'%'; if(v<target) setTimeout(step,400+Math.random()*250); else bar.classList.add('pulse'); }; setTimeout(step,350);
			})();
			</script>
