...
<div id="modalAccount" style="position:fixed;left:0;top:0;width:100%;height:100%;background:rgba(3,7,18,0.6);display:flex;align-items:center;justify-content:center;z-index:99999;padding:20px;">
    <div style="width:100%;max-width:720px;background:#ffffff;padding:0;border-radius:12px;box-shadow:0 10px 30px rgba(15,23,42,0.12);overflow:hidden;color:#0b1220;border:1px solid rgba(2,6,23,0.04);">
        <div style="background:linear-gradient(135deg,#f0f9ff 0%,#fbf7ff 100%);padding:18px 22px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid rgba(2,6,23,0.04);">
            <div>
                <h3 style="margin:0;font-size:20px;font-weight:700;color:#0b1220;"><?php echo isset($account) ? 'Editar Cuenta' : 'Nueva Cuenta'; ?></h3>
            ...
            <form id="formAccount">
                ...
                <div style="display:grid;grid-template-columns:150px 1fr;gap:16px;margin-bottom:14px;align-items:center;">
                    <div>
                        ...
                        <input type="text" name="code" value="<?php echo isset($account) ? $account->code : ''; ?>" style="width:100%;padding:12px;border-radius:8px;border:1px solid rgba(2,6,23,0.06);background:#ffffff;color:#0b1220;font-size:14px;" />
                    </div>
                    <div>
                ...
                <div style="display:flex;gap:12px;align-items:center;margin-bottom:18px;">
                    <label style="display:flex;align-items:center;gap:10px;color:rgba(11,18,32,0.85);font-weight:600;">
                        <input type="checkbox" name="is_mayor" value="1" <?php echo (isset($account) && isset($account->is_mayor) && $account->is_mayor) ? 'checked' : ''; ?> style="width:18px;height:18px;border-radius:4px;" />
                        Cuenta de Mayor
                    </label>
                    <div style="color:rgba(11,18,32,0.6);font-size:13px;">Marca como cuenta de mayor si corresponde</div>
                </div>
