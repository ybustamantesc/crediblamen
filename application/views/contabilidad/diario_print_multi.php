...
<head>
    <meta charset="utf-8" />
    <title>Libro Diario - <?php echo isset($empresa->razon_social) ? htmlspecialchars($empresa->razon_social) : ''; ?></title>
    <style>
...
<body>
    ...
    ?>
        <div class="header">
            <div style="font-size:14px;font-weight:700;">LIBRO DIARIO</div>
        </div>
        <div class="meta">
            <div class="meta-left">
