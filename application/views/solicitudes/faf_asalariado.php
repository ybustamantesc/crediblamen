                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($s->faf_asalariado)): ?>
                                            <button class="btn btn-sm btn-success" onclick="openFafModal(<?php echo $s->idsolicitud; ?>, 'asalariado')">Ver / Editar FAF</button>
                                        <?php else: ?>
                                            <?php if (!empty($s->faf_comerciante)): ?>
                                                <button class="btn btn-sm btn-secondary" disabled title="Bloqueado: FAF Comerciante ya completado">Bloqueado (Comerciante)</button>
                                            <?php else: ?>
                                                <button class="btn btn-sm btn-primary" onclick="openFafModal(<?php echo $s->idsolicitud; ?>, 'asalariado')">Crear FAF</button>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </td>
                                </tr>
