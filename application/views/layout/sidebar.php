				...
				<?php if ($perfil == 1) : ?>
					...
					<div class="nav-item has-sub active open">
						...
						<div class="submenu-content">
							...
							<a href="<?php echo base_url('tesoreria/integracion'); ?>" class="menu-item <?php echo ($this->router->fetch_method() == 'integracion' ? 'active' : ''); ?>"><i class="fas fa-link"></i><span>Integración Contable</span></a>
				...
				<?php if ($perfil == 2) : ?>
					...
					<div class="nav-item has-sub active open">
						...
						<div class="submenu-content">
							...
							<a href="<?php echo base_url('tesoreria/integracion'); ?>" class="menu-item">Integración Contable</a>
