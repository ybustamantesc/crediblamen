...
<head>
    ...
    <title>Sistema | <?php echo (isset($titulo) ? $titulo : 'Un nuevo concepto de estacionamiento') ?> </title>
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="text-center">
                ...
                <p class="lead text-gray-900 mb-5">Página no encontrada</p>
                <p class="mb-5">La página que está intentando ingresar no existe.</p>
                <a class="btn btn-danger" href="<?php echo base_url('/'); ?>">Ir a la página principal</a>
            </div>
