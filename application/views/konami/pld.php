                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            ...
                            <div class="d-inline">
                                <h5>Gestión de Usuarios – PLD/FT</h5>
                                <span>KYC, verificación listas y expediente digital</span>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card"><div class="card-body"><p class="text-muted">Placeholder para KYC y verificaciones sin contenido sensible.</p></div></div>
        </div>
    </div>
