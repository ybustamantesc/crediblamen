                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            ...
                            <div class="d-inline">
                                <h5>Operaciones Inusuales</h5>
                                <span>Alertas internas y registro de análisis</span>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card"><div class="card-body"><p class="text-muted">Placeholder para alertas por montos/patrones y reportes del oficial.</p></div></div>
        </div>
    </div>
