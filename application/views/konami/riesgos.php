                    ...
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            ...
                            <div class="d-inline">
                                ...
                                <span>Matriz e indicadores obligatorios</span>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card"><div class="card-body"><p class="text-muted">Placeholder para matriz de riesgos y reportes de auditoría.</p></div></div>
        </div>
    </div>
