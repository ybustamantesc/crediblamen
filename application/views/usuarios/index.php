                                    ...
                                    <tbody>
                                        <?php foreach ($usuarios as $user) : ?>
                                            <tr>
                                                ...
                                                <td><?php echo ($this->ion_auth->is_admin($user->id) ? 'Administrador' : 'Empleado'); ?></td>
                                                <td><?php echo ($user->active == 1 ? '<span class="badge badge-success mb-1"><i class="fas fa-lock-open"></i> SÍ</span> ' : '<span class="badge badge-warning mb-1"><i class="fas fa-lock"></i> NO</span>'); ?> </td>
                                                <td>
                                                    <div class="table-actions">

                                                        <a href="<?php echo base_url($this->router->fetch_class() . '/core/' . $user->id) ?>" data-toggle="tooltip" data-placement="top" title="Editar <?php echo $this->router->fetch_class(); ?>"><i class="ik ik-edit f-16 mr-15 text-success"></i></a>
                                                        <a href="" data-toggle="modal" data-target="#user-<?php echo $user->id ?>" data-toggle="tooltip" data-placement="top" title="Eliminar <?php echo $this->router->fetch_class(); ?>"><i class="ik ik-trash-2 f-16 text-danger"></i></a>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?php echo base_url($this->router->fetch_class() . '/del/' . $user->id) ?>" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Eliminar <?php echo $this->router->fetch_class(); ?>"> Sí, eliminar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
