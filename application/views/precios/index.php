                                ...
                                <table class="table data-table table-sm pl-20 pr-20">
                                    ...
                                    <tbody>
                                        <?php foreach ($precios as $precio) : ?>
                                            <tr>
                                                <td><?php echo $precio->precio_id; ?> </td>
                                                <td><?php echo $precio->precio_categoria; ?> </td>
                                                <td><?php echo $precio->precio_valor_hora; ?> </td>
                                                <td><?php echo $precio->precio_valor_mensualidad; ?> </td>
                                                <td class="text-center"><?php echo $precio->precio_numero_vacantes; ?></td>
                                                <td><?php echo ($precio->precio_estado == 1 ? '<span class="badge  badge-success mb-1"><i class="fas fa-check-circle"></i></span>' : '<span class="badge badge-warning mb-1"><i class="fas fa-lock"></i></span>'); ?> </td>
                                                <td>
                                                    <div class="table-actions">
                                                        <a href="<?php echo base_url($this->router->fetch_class() . '/core/' . $precio->precio_id) ?>" data-toggle="tooltip" data-placement="top" title="Editar <?php echo $this->router->fetch_class(); ?>"><i class="ik ik-edit f-16 mr-15 text-success"></i></a>
                                                        <a href="" data-toggle="modal" data-target="#precio-<?php echo $precio->precio_id ?>" data-toggle="tooltip" data-placement="top" title="Eliminar <?php echo $this->router->fetch_class(); ?>"><i class="ik ik-trash-2 f-16 text-danger"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <div class="modal fade" id="precio-<?php echo $precio->precio_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?php echo base_url($this->router->fetch_class() . '/del/' . $precio->precio_id) ?>" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Eliminar <?php echo $this->router->fetch_class(); ?>"> Sí, eliminar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
