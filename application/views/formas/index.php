                                    ...
                                    <tbody>
                                        <?php foreach ($formas as $forma) : ?>
                                            <tr>
                                                ...
                                                <td><?php echo ($forma->estado == 1 ? '<span class="badge  badge-success mb-1"><i class="fas fa-check-circle"></i></span>' : '<span class="badge badge-warning mb-1"><i class="fas fa-lock"></i></span>'); ?> </td>
                                                <td>
                                                    <div class="table-actions">
                                                        <a href="<?php echo base_url($this->router->fetch_class() . '/core/' . $forma->id) ?>" data-toggle="tooltip" data-placement="top" title="Editar <?php echo $this->router->fetch_class(); ?>"><i class="ik ik-edit f-16 mr-15 text-success"></i></a>
                                                        <a href="" data-toggle="modal" data-target="#forma-<?php echo $forma->id ?>" data-toggle="tooltip" data-placement="top" title="Eliminar <?php echo $this->router->fetch_class(); ?>"><i class="ik ik-trash-2 f-16 text-danger"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <div class="modal fade" id="forma-<?php echo $forma->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?php echo base_url($this->router->fetch_class() . '/del/' . $forma->id) ?>" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Eliminar <?php echo $this->router->fetch_class(); ?>"> Sí, eliminar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
