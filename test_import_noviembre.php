<?php
// Script de prueba para importar la balanza de noviembre 2025 desde el archivo en temp/
// Ejecutar: php test_import_noviembre.php

$csvPath = 'C:/xampp/htdocs/lasminitas/temp/ejemplo_balanza_Noviembre_2025.csv';
