...
CREATE TABLE `users_backup` (
  `id` int(11) UNSIGNED NOT NULL,
  `ip_address` varchar(45) CHARACTER SET utf8mb3  NOT NULL,
  `username` varchar(100) CHARACTER SET utf8mb3  DEFAULT NULL,
  `password` varchar(255) CHARACTER SET utf8mb3  NOT NULL,
  `email` varchar(254) CHARACTER SET utf8mb3  NOT NULL,
  `activation_selector` varchar(255) CHARACTER SET utf8mb3  DEFAULT NULL,
  `activation_code` varchar(255) CHARACTER SET utf8mb3  DEFAULT NULL,
  `forgotten_password_selector` varchar(255) CHARACTER SET utf8mb3  DEFAULT NULL,
  `forgotten_password_code` varchar(255) CHARACTER SET utf8mb3  DEFAULT NULL,
  `forgotten_password_time` int(11) UNSIGNED DEFAULT NULL,
  `remember_selector` varchar(255) CHARACTER SET utf8mb3  DEFAULT NULL,
  `remember_code` varchar(255) CHARACTER SET utf8mb3  DEFAULT NULL,
  `created_on` int(11) UNSIGNED NOT NULL,
  `last_login` int(11) UNSIGNED DEFAULT NULL,
  `active` tinyint(1) UNSIGNED DEFAULT NULL,
  `first_name` varchar(50) CHARACTER SET utf8mb3  DEFAULT NULL,
  `last_name` varchar(50) CHARACTER SET utf8mb3  DEFAULT NULL,
  `company` varchar(100) CHARACTER SET utf8mb3  DEFAULT NULL,
